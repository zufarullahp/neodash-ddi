  ...
  const content = (
    <div className='n-items-center sm:n-flex md:n-flex-1 n-justify-start'>
      <a className='n-cursor-pointer'>
        <img onClick={resetApplication} className='n-h-12 n-w-auto n-m-3' src={DASHBOARD_HEADER_BRAND_LOGO} alt='Logo' />
      </a>
      {IS_CUSTOM_LOGO ? <></> : <Typography variant='h6'>Peruri Graph Analytic</Typography>}
    </div>
  );
